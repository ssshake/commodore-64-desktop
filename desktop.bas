...
143 POKE V + 21,255: GOSUB 2000 : REM RENDER LIST : REM DO NOT CHANGE THIS LINE
...
3155 IF KEY$ = "7" THEN I = 6 : GOSUB 4000
3156 IF KEY$ = "8" THEN I = 7 : GOSUB 4000
...
6033 POKE 646,3: ROW=0:COL=0:GOSUB 7000
...
9018 IF BV < 1 THEN BV = 1
9020 A = PEEK(BV) AND 255: D=256:

9030 IF W = 1104 THEN ROW=0: COL=10: GOSUB 7000: POKE646,1 : PRINT "                          " : 
9040 IF W = 1104 THEN ROW=0: COL=13: GOSUB 7000: POKE646,INT(RND(1)*15)+1: PRINT BV "-" BV + 114
9050 FORM=0TO6: POKE 55296 - 1024 + W,1: POKE W,97: BC=BN : IF INT(RND(1)*6) = 1 THEN BC = BN:REM13
 
9060 D=D/2:B=INT(A / D)
9070 A = A - (B * D): 

9080 POKE W,ASC(RIGHT$(STR$(B),1)):POKE 55296 - 1024 + W, BC: W=W+1: IF W >= 2024 THEN W = 1104: G=FRE(0)
9090 NEXT
9100 POKE W,ASC(RIGHT$(STR$(A),1)): POKE 55296 - 1024 + W, BC: W=W+1: IF W >= 2024 THEN W = 1104: G=FRE(0)
9110 BN = 5
