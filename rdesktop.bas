...
7 DELIMITER$=">  "
8 LNGTH = 5:SX=0:SY=100

9 PROGRAM$(0,0)="FILES"
10 PROGRAM$(1,0)="TERMINAL"
11 PROGRAM$(2,0)="PAINT"
12 PROGRAM$(3,0)="WORD"
13 PROGRAM$(4,0)="SHEETS"
14 REM PROGRAM$(5,0)="BASIC"
15 PROGRAM$(5,0)="MUSIC"
...
138 PRINT CHR$(147)
139 ROW = 12: COL = 12: GOSUB 7000: PRINT "LOADING DESKTOP..."
140 GOSUB 1000 : REM PRETTY LINES
141 GOSUB 6000 : REM RENDER SPRITES
142 ROW = 12: COL = 12: GOSUB 7000: PRINT "                  "
143 GOSUB 2000 : REM RENDER LIST
150 GOSUB 3500 : REM SET CURSOR
151 ROW = 3: COL = 22: GOSUB 7000: PRINT "DAGGATOP V0.2.4"
152 ROW = 2: COL = 2: GOSUB 7000: PRINT "F1 = HELP"
153 ROW = 3: COL = 2: GOSUB 7000: PRINT "F3 = CONSOLE"
154 ROW = 4: COL = 2: GOSUB 7000: PRINT "F5 = SCREENSAVER"
...
3002 GOSUB 3400
3003 IF KEY$ = CHR$(13) THEN GOSUB 4000 : REM LAUNCH APP
3004 IF KEY$ = CHR$(134) THEN GOSUB 5000
3005 IF KEY$ = "" THEN I = I + 3
3006 IF KEY$ = "" THEN I = I + 1
3007 IF KEY$ = "" THEN I = I - 3
3008 IF KEY$ = "" THEN I = I - 1
3009 IF KEY$ = "1" THEN I = 0 : GOSUB 4000
3010 IF KEY$ = "2" THEN I = 1 : GOSUB 4000
3011 IF KEY$ = "3" THEN I = 2 : GOSUB 4000
3012 IF KEY$ = "4" THEN I = 3 : GOSUB 4000
3013 IF KEY$ = "5" THEN I = 4 : GOSUB 4000
3014 IF KEY$ = "6" THEN I = 5 : GOSUB 4000
3015 IF KEY$ = CHR$(133) THEN GOSUB 8000
3016 IF KEY$ = CHR$(135) THEN GOSUB 9000
...
3501 POKE (1024 + XY(I, 0) + 40 * XY(I, 1)) - 1, 90
3502 POKE (55296 + XY(I, 0) + 40 * XY(I, 1)) - 1,13


3530  FOR X = 0 TO 12
3531  SX = SX + X
3540  POKE V + 0,SX : REM UPDATE X COORDINATES
3550  POKE V + 1,SY : REM UPDATE Y COORDINATES
3560  NEXT X
...
5000 ROW = 23: COL = 6: GOSUB 7000
5010 PRINT "DIR LISTING SOMEDAY        "
...
6091 POKE V + 2, 80 : REM FILES
6092 POKE V + 3, 100

6093 POKE V + 4, 160 : REM TERMIANL
6094 POKE V + 5, 100

6095 POKE V + 6, 240 : REM PAINT
6096 POKE V + 7, 100

6097 POKE V + 8, 80 : REM WORD
6098 POKE V + 9, 160

6099 POKE V + 10, 160 : REM SHEETS
6100 POKE V + 11, 160

6101 POKE V + 12, 240 : REM BASIC
6102 POKE V + 13, 160
