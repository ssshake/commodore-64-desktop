...
9017 BV=1: BC=5: W=1104: BN=5:CV=0
9018 A = PEEK(BV) AND 255: D=256

9019 IF W = 1104 THEN ROW=0: COL=10: GOSUB 7000: POKE646,1 : PRINT "                          " : 
9020 IF W = 1104 THEN ROW=0: COL=7: GOSUB 7000: POKE646,INT(RND(1)*15)+1: PRINT "BYTE RANGE: " BV "-" BV + 920
9021 FORM=0TO6:POKE 55296 - 1024 + W,1: POKE W,118: BC=BN : IF INT(RND(1)*6) = 1 THEN BC = BN:REM13
 
9022 D=D/2:B=INT(A / D)
9023 A = A - (B * D): 

9026 POKE W,ASC(RIGHT$(STR$(B),1)):POKE 55296 - 1024 + W, BC: W=W+1: IF W = 2024 THEN W = 1104:
9027 NEXT
9028 POKE W,ASC(RIGHT$(STR$(A),1)): POKE 55296 - 1024 + W, BC: W=W+1: IF W = 2024 THEN W = 1104:
9030 BN = 5
