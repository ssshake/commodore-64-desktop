...
9017 BV=1: BC=5: W=1024
9018 A = PEEK(BV) AND 255

9019 D=256 
9020 FORM=0TO6:POKE 55296 - 1024 + W,1: POKE W,97: BC=5 : IF INT(RND(1)*6) = 1 THEN BC = 13
...
9030 REM PRINT "DEBUG >" BV

9033 REM PRINT CHR$(205.5+RND(1));
9034 REM PRINT CHR$(48.5+RND(1));
