...
140 GOSUB 1071 : REM PRETTY LINES
...
3001 TMOUT = TMOUT + 1: IF TMOUT > 500 THEN TMOUT = 0: GOSUB 9000
3002 GET KEY$: IF KEY$ = "" THEN ROW = 0: COL = 0: GOSUB 7000: PRINT TMOUT: GOTO 3001
...
5000 ROW = 13: COL = 6: GOSUB 7000
5005 POKE 19,65 
5010 POKE V + 21,0 : REM DISABLE SPRITES
5020 PRINT CHR$(147)
5030 GOSUB 10000 : REM DIR LISTING
5035 ROW = 23: COL = 0: GOSUB 7000
5040 INPUT "> "; IP$
5050 IF IP$ = "EXIT" THEN PRINT CHR$(147): POKE V + 21,255 : GOSUB 143
5060 IF IP$ = "DIR" THEN GOSUB 10000
...
10000 REM DIR
10004 ROW = 2: COL = 1: GOSUB 7000
10006 D=PEEK(186):REM LAST USED DRIVE NUMBER, YOU CAN FORCE 8 IF < 8 
10008 GOSUB11000 
10010 RETURN

11000 SYS57812"$",D:POKE43,1:POKE44,192:POKE768,174:POKE769,167:SYS47003,1 
11010 POKE782,192:SYS65493:SYS42291:LIST:POKE44,8:POKE768,139:POKE769,227 
11020 RETURN 
