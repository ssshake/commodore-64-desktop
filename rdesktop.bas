...
9019 D=256 
9020 FORM=0TO6: BC=BN : IF INT(RND(1)*6) = 1 THEN BC = BN:REM13
 
9022 D=D/2:B=INT(A / D)
9023 A = A - (B * D): 

9026 POKE 55296 - 1024 + W, BC: POKE W,ASC(RIGHT$(STR$(B),1)): W=W+1: IF W = 2024 THEN W = 1024:
9027 NEXT
9028  POKE 55296 - 1024 + W, BC : POKE W,ASC(RIGHT$(STR$(A),1)): W=W+1: IF W = 2024 THEN W = 1024:
