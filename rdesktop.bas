...
9019 D=256 
9020 FORM=0TO6:POKE 646,1: POKE W,ASC(RIGHT$(STR$(161),1)): BC=5 : IF INT(RND(1)*6) = 1 THEN BC = 13
9021 POKE 646,BC:D=D/2:B=INT(A / D)

9026 A = A - (B * D): POKE W,ASC(RIGHT$(STR$(B),1)):POKE 55296 - 1024 + W, BC: W=W+1: IF W = 2024 THEN W = 1024:
9027 NEXT
9028 POKE W,ASC(RIGHT$(STR$(A),1)): POKE 55296 - 1024 + W, BC
